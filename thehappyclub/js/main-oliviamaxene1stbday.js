/**
 * main.js
 * Combined: dynamic folder reading + lazy load + Load More + full lightbox + download modal
 *
 * Notes:
 * - GIF folder expects .mp4 files (as you requested).
 * - If `fetch` folder listing fails (e.g. file:// or server doesn't expose directory listing),
 *   the script falls back to sample arrays generated by createImageArray/createVideoArray.
 */
...
(function () {
  ...
  const SAMPLE_EVENTS = [
    {
      id: 'e1',
      title: 'Olivia Maxene Birthday and Thanksgiving',
      date: 'November 8, 2025',
      banner: 'images/20251108OliviaMaxene1stBDay/cover.jpg',
      thumb: 'images/20251108OliviaMaxene1stBDay/cover.jpg',
      folder: '20251108OliviaMaxene1stBDay',
